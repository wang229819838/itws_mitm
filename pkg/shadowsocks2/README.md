...
GoDoc at https://godoc.org/socks5_mitm/pkg/shadowsocks2/

![Build and test](https://socks5_mitm/pkg/shadowsocks2/workflows/Build%20and%20test/badge.svg)
...
Pre-built binaries for common platforms are available at https://socks5_mitm/pkg/shadowsocks2/releases

Install from source

```sh
go install -u socks5_mitm/pkg/shadowsocks2@latest
```
